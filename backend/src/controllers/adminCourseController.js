...
async function deleteCourse(req, res) {
  const { id } = req.params;
  await prisma.course.delete({ where: { id } }); // cascades to sections/lessons
...
// ---------- Enrollments (read-only view for admin) ----------
...
// GET /api/admin/categories — the fixed taxonomy, so the frontend never
// hardcodes a second copy of this list
