...
const PHONE_NUMBER = "233248632153";
...
export default function WhatsAppButton() {
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" aria-label="Chat with Aaron on WhatsApp"
      ...
      <svg viewBox="0 0 32 32" width="28" height="28" fill="white" className="relative z-10">
