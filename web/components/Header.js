        ...
        <nav className="flex items-center gap-6">
          <div className="relative" ref={coursesRef}>
            <button
              ...
              className="flex items-center gap-1 text-sm font-medium hover:text-gold transition"
            >
              Courses
              <svg
                width="10"
          ...
          {loggedIn ? (
            <button
              ...
              className="px-4 py-2 rounded-lg border border-gold/40 text-sm font-semibold hover:bg-gold/10 transition"
            >
              Log out
            </button>
          ) : (
            <div className="relative" ref={authRef}>
              <button
                ...
                className="px-4 py-2 rounded-lg bg-gold text-ink text-sm font-semibold hover:opacity-90 transition"
              >
                Login
              </button>
              {authOpen && (
                <div className="absolute top-full right-0 mt-2 w-48 bg-white dark:bg-deep border border-gold/20 rounded-xl shadow-xl overflow-hidden">
                    ...
                    className="block px-4 py-3 text-sm hover:bg-gold/10 transition font-medium"
                  >
                    Log in
                  </a>
                    ...
                    href="/signup"
                    onClick={() => setAuthOpen(false)}
                    className="block px-4 py-3 text-sm border-t border-gold/10 text-gold hover:bg-gold/10 transition"
                  >
                    Sign up
                  </a>
                </div>
